<script>
  ...
  function getpricedata()
	{
		var getminprice="<?=$getminprice?>";
		var getmaxprice="<?=$getmaxprice?>";
		...
		pageurl = "<?php echo site_url('your_cycle/ajaxwhich_cycle_price'); ?>/"+getminprice+"/"+getmaxprice;
		...
		if(select_brandcount==0)
		 {
			$.ajax({				
				type: "POST",
				url:"<?php echo site_url('your_cycle/ajaxwhich_cycle_price'); ?>/"+getminprice+"/"+getmaxprice,
				...
				success: function(data){
					...
					$(".ajaxwhich_cycle_price").html(data.body);
...
<script>
   ...
   $(document).ready(function () {
	...
	function GetAjaxList(pageurl,getminprice,getmaxprice)
		{	
			if(jQuery('#showgrid').val()==""){
				var limit = 1;
			}else{
			...
			parpage = "<?php echo site_url('your_cycle/ajaxwhich_cycle_price'); ?>/"+getminprice+"/"+getmaxprice+""+pageurl;
			//alert(parpage);
		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-4 leftfilterbar">
				...
				<div class="selectprice">
				  ...
				  <input type="text" name="amount"  id="amount" value="<?=$getminprice?>"readonly style="border:0; color:#f6931f; font-weight:bold;"> 
				  <input type="text" name="amount1"  id="amount1" value="<?=$getmaxprice?>" readonly style="border:0; color:#f6931f; font-weight:bold;">
				</div>
			...
			<div class="col-md-9 col-sm-8">
				...
				<div class="row ajaxwhich_cycle_price">
				</div>
				<div class="row">
					<div class="col-md-4 col-md-offset-8">
					    <input type="hidden" name="showgrid" id="showgrid" >
