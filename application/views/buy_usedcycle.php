  ...
  function getpricedata()
	{
		...
		pageurl = "<?php echo site_url('your_cycle/ajaxbuy_usedcycle'); ?>";
		...
		if(select_brandcount==0 && select_modeltypecount==0 && select_accessoriescount==0)
		 {
			$.ajax({				
				type: "POST",
				url:"<?php echo site_url('your_cycle/ajaxbuy_usedcycle'); ?>",
				...
				success: function(data){
					$(".ajaxbuy_usedcycle").html(data.body);
   ...
   $(document).ready(function () {
	...
	function GetAjaxList(pageurl)
		{	
			...
			parpage = "<?php echo site_url('your_cycle/ajaxbuy_usedcycle'); ?>"+pageurl;
			//alert(parpage);
...
<div class="comingsoonpage martop64">
      <? 
		 $range=$this->buyusedcycle_model->getallpricebyid();
	...
	<div class="container">
	  <div class="row">
		<div class="col-md-12">
			<h1>BUY <span class="redcolor">USED CYCLE</span></h1>
	  ...
	  <div class="accessorieslist fntcentury">
		<div class="row">
			...
			<div class="col-md-9 col-sm-8">
				...
				<div class="row ajaxbuy_usedcycle">
				</div>
				<div class="row">
					<div class="col-md-4 col-md-offset-8">
					    <input type="hidden" name="showgrid" id="showgrid" >
...
<script>
 ...
 /* $("#price").change(function () {
	...
	alert(price);
    $.ajax({
      url: '<?php echo base_url(); ?>buy_usedcycle/price',
      type: 'POST',
      data: {price: price},
      success: function (data) {
       $('#price').value(result);
