<div class="row-fluid">
    ...
    <div class="box ">
        <div class="box-header with-border"> Posted Sell Cycle Details </div>
        <div class="box-body with-border">
            <!-- text input -->
            <form  enctype="multipart/form-data" action="<?php echo site_url('admins/post_cycle/changestatus'); ?>" method="post">
			    ...
			    <table  border="0" cellpadding="5" cellspacing="1" width="100%" class="tblDisplay widthPc">
							...
							<tr class="odd">
								...
								<td> 
									<?php if(count($this->post_cycle_model->getbrandname($result[0]['brand_id'])))
											{
											  echo $this->post_cycle_model->getbrandname($result[0]['brand_id']);
											}
										 ?>
								</td>
							</tr>
							...
							<tr class="odd">
								...
								<td> 
									<?php if(count($this->post_cycle_model->getmodelname($result[0]['model_id'])))
											{
											   echo($this->post_cycle_model->getmodelname($result[0]['model_id'])); 
											}
										 ?>
								</td>
							</tr>
							...
							<tr class="odd">
								...
								<td> 
									<?php if ($result[0]['img2'] != '') { ?>
									  <img src="<?php echo site_url('upload/buysell');?>/<?php echo $result[0]['img2']; ?>" width="100" />
								   <?php } ?>
								</td>
							</tr>
