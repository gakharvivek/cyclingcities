<div class="row-fluid">
    ...
    <div class="box ">
        <div class="box-header with-border"> Reject Try Cycle </div>
        <div class="box-body with-border">
            <!-- text input -->
            <form  enctype="multipart/form-data" action="<?php echo site_url('admins/post_cycle/rejecttrycyclestatus'); ?>" method="post">
