                ...
                <div class="box-body with-border">
                  <?php echo form_open('Category/edit'); ?>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="cate_desc" value="<?php echo $result['cate_desc'] ?>"/>
                    </div>
                    ...
                    <div class="">
					  ...
					  <a href="<?php echo site_url('admins/Category');?>" class="btn btn-group btn-primary">Cancel</a>
                    </div>
                    <?php form_close(); ?>
                </div>
	</div>
