  ...
  function getpricedata()
	{
		...
		pageurl = "<?php echo site_url('your_cycle/ajaxwhich_cycle_brand'); ?>/"+brandid;
		...
		if(select_brandcount==0)
		 {
			$.ajax({				
				type: "POST",
				url:"<?php echo site_url('your_cycle/ajaxwhich_cycle_brand'); ?>/"+brandid,
				...
				success: function(data){
					...
					$(".ajaxwhich_cycle_brand").html(data.body);
...
<script>
   ...
   $(document).ready(function () {
	...
	function GetAjaxList(pageurl,brandid)
		{	
			if(jQuery('#showgrid').val()==""){
				var limit = 1;
			}else{
			...
			parpage = "<?php echo site_url('your_cycle/ajaxwhich_cycle_brand'); ?>/"+brandid+""+pageurl;
			//alert(parpage);
	  ...
	  <div class="accessorieslist fntcentury">
		<div class="row">
				  ...
				  <div class="selectbrand">
					...
					<ul class="selectbrandone">
					    <?
						  ...
						  {?>
						    <li><input id="select_brand<?=$i;?>" type="checkbox" name="select_brand[]" value="<?=$row['brand_id'];?>" <?if($row['brand_id']==$brandid){?> checked <?}?>><label for="select_brand<?=$i;?>"><?=$row['brand_name'];?></label></li>
						<? $i++;
						  }?>
					</ul>
				  </div>
			...
			<div class="col-md-9 col-sm-8">
				...
				<div class="row ajaxwhich_cycle_brand">
				</div>
				<div class="row">
					<div class="col-md-4 col-md-offset-8">
					    <input type="hidden" name="showgrid" id="showgrid" >
