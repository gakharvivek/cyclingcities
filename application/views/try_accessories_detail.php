...
<div class="col-md-6 col-sm-6">
	<img src="<? echo site_url('assets/images/img_accessories.png');?>" alt="" class="img-responsive"/>
    <div class="pricebox">Rs. <span class="redcolor">21,500/-</span></div>
</div>
<div class="col-md-5 col-sm-6 col-md-offset-1">
<a href="<? echo site_url('your_cycle/tryaccessories');?>" class="redcolor pull-right">Back</a>
	<div class="detailtext fntcentury">
    	<span><strong>BRAND</strong> LOREM IPSUM DOLOR </span>
        <span><strong>MODEL</strong> LOREM IPSUM  </span>
        <span><strong class="blackfnt">ACCESSORIES</strong>BELL </span>
        <span><strong class="blackfnt">PURCHASE YEAR</strong> 2014 </span>        
    </div>
</div>	
</div>
</div>
...
<div class="col-md-6 col-sm-6">
    ...
    <p class="fnt12">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt.</p>
</div>
...
Ashish Prajapati<br/>
admim@gmail.com<br/>
 9898123456 <span class="redcor">AVAILABLE ON WHAT'S APP</span>
</div>
...
<div class="row">
	<div class="col-md-12">
    	<div class="bycyclebtn fntcentury"> <a href="#" data-toggle="modal" data-target="#myModalform"><strong>BUY</strong> NEW CYCLE</a> <a href="#" class="ver_line darkred"><strong>TRY</strong> CYCLE</a></div>
    </div>
</div>
